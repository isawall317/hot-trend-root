...
| baidu | 百度·千帆 | console.bce.baidu.com/qianfan/resource/token-plan | qianfan.baidubce.com | manual | 待添加 | 需登录控制台；个人版: cloud.baidu.com/doc/qianfan/s/Dmrabu8b6；Coding Plan: cloud.baidu.com/doc/qianfan/s/imlg0beiu |
