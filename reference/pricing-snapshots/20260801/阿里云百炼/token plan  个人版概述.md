...
|**每 5 小时限额**|700 Credits|3,000 Credits|12,000 Credits|无限制|
|**并发 Agent**|1-2 个|3-4 个|6-8 个|-|
|**权益**|文本、视觉等多模态模型<br><br>联网搜索等 Harness 工具<br><br>适配主流工具并持续扩展|享受 Lite 套餐所有权益<br><br>4x Lite 套餐用量|享受 Standard 套餐所有权益<br><br>16x Lite 套餐用量<br><br>更高的并发上限|不受 5 小时和 7 天限额约束<br><br>需先订阅套餐后购买<br><br>最多同时持有 5 个|
...
|千问|qwen3.8-max-preview|推理模型、视觉理解、文本生成|
